...
const TRANSLATIONS = {
  en: {
    ...
    'logs.lock': 'Lock',
    'logs.subtitle': 'The most recent 10 requests and errors handled by the live server - download everything below to see the full history, stored permanently so it survives restarts and redeploys.',
    ...
    'logs.sourceOriginal': '(Original)',
    'logs.sourceCustom': '(Your Data)',
    'logs.invalid': 'Invalid',
    'logs.predictionsTitle': 'Eligibility Check Submissions',
    'logs.predictionsSubtitle': 'The most recent 10 "Check Loan Eligibility" submissions, including the values entered and the outcome - download everything below to see the full history.',
    ...
    'custom.uploadingElapsed': 'Training... {seconds}s',
    ...
    'custom.yourDataTitle': 'Your Uploaded Data',
    'custom.originalDataLabel': 'Real Model (Original)',
  },
  he: {
    dir: 'rtl',
    currencySymbol: '₪',
    ...
    'logs.refresh': 'רענון',
    'logs.lock': 'נעילה',
    'logs.subtitle': '10 הבקשות והשגיאות האחרונות שהשרת החי טיפל בהן - ניתן להוריד את כל ההיסטוריה למטה. נשמרות לצמיתות כך שהן שורדות הפעלות מחדש ופריסות מחדש.',
    'logs.downloadAll': 'הורדת הכל',
    ...
    'logs.colSource': 'מקור',
    'logs.sourceOriginal': '(מקורי)',
    'logs.sourceCustom': '(הנתונים שלכם)',
    'logs.invalid': 'לא תקין',
    'logs.predictionsTitle': 'בקשות בדיקת זכאות',
    'logs.predictionsSubtitle': '10 בקשות "בדיקת זכאות להלוואה" האחרונות, כולל הערכים שהוזנו והתוצאה - ניתן להוריד את כל ההיסטוריה למטה.',
    ...
    'custom.uploadingElapsed': 'מאמן... {seconds} שניות',
    ...
    'custom.yourDataTitle': 'הנתונים שהעליתם',
    'custom.originalDataLabel': 'המודל האמיתי (מקורי)',
  },
};
